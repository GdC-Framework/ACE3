    ...
    if (!_cpcRun) then {
        ...
        nul = [_intensity] spawn {
            ...
            while {_cpcStrengthIterations > 0} do {
                ...
                //GVAR(ppPainCPCDB) ppEffectAdjust [(_this select 0)];
                ...
                //playSound "ACE_heartbeat_cpc";
                //ACE_player setVariable ["tf_globalVolume", 0.4];
                //ACE_player setVariable ["tf_voiceVolume", 0, true];
                
                // Little sound from the victime (random)
                /*_cpcRandomPainShout = floor(random 2);
                if (_cpcRandomPainShout == 1) then {
                    _cpcPainShout = floor(random 8);
                    switch(_cpcPainShout) do 
                    {
                        case 0:
                        {
                            playSound3D ["A3\missions_f_epa\data\sounds\WoundedGuyB_01.wss", player, false, getPosASL player, 1.5, 1, 20];
                        };
                        case 1:
                        {
                            playSound3D ["A3\missions_f_epa\data\sounds\WoundedGuyB_02.wss", player, false, getPosASL player, 1.5, 1, 20];
                        };
                        case 2:
                        {
                            playSound3D ["A3\missions_f_epa\data\sounds\WoundedGuyB_03.wss", player, false, getPosASL player, 1.5, 1, 20];
                        };
                        case 3:
                        {
                            playSound3D ["A3\missions_f_epa\data\sounds\WoundedGuyB_04.wss", player, false, getPosASL player, 1.5, 1, 20];
                        };
                        case 4:
                        {
                            playSound3D ["A3\missions_f_epa\data\sounds\WoundedGuyB_05.wss", player, false, getPosASL player, 1.5, 1, 20];
                        };
                        case 5:
                        {
                            playSound3D ["A3\missions_f_epa\data\sounds\WoundedGuyB_06.wss", player, false, getPosASL player, 1.5, 1, 20];
                        };
                        case 6:
                        {
                            playSound3D ["A3\missions_f_epa\data\sounds\WoundedGuyB_07.wss", player, false, getPosASL player, 1.5, 1, 20];
                        };
                        case 7:
                        {
                            playSound3D ["A3\missions_f_epa\data\sounds\WoundedGuyB_08.wss", player, false, getPosASL player, 1.5, 1, 20];
                        };
                    };
                };*/
                sleep 0.9;
                ...
                //ACE_player setVariable ["tf_voiceVolume", 1, true];
